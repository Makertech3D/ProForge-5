# ProForge 5 Tool Changer 3D Printer

ProForge 5 is an advanced, open-source, 5+ toolhead tool-changing 3D printer platform designed for high-speed, high-precision multi-material and multi-tool printing. This repository contains firmware config files, STL models for 3d printed parts and other documentation.

Available to order [here.](https://www.makertech3d.com/pages/proforge-5)
...
# Features
  ...
  •	Geniuine Raspberry Pi 5 processor board and Bigtreetech Octopus Pro Control Board.
  •	Premium component selection - Meanwell PSU, GATES belts, Stainless Steel rails and bearings.
...
The Official build guides for the ProForge 5 3D printer can be found [here](https://makertech-3d.dozuki.com/c/ProForge_5)

# Support and Community

If you run into any issues or need assistance with assembly or printing, feel free to ask for help in the official [Discord Server](https://discord.com/invite/FwgXFUw4R4)  or [Facebook Group](https://www.facebook.com/groups/proforge5).
...
Operate the ProForge 5 in a well ventilated, open and dry environment.
...
Keep children and pets away from the ProForge 5 whilst in operation.
...
MAKERTECH 3D IS NOT RESPONSIBLE FOR ANY PRODUCTS (3D PRINTED PARTS OR OTHER) PRODUCED WITH THE PROFORGE 5 OR ANY OF ITS OTHER PRODUCTS. IN NO EVENT SHALL MAKERTECH 3D BE LIABLE FOR ANY DAMAGE OR INJURY OCCURRED BY USING PRODUCTS PRODUCED BY THE PROFORGE 5 OR ANY OF ITS OTHER PRODUCTS.
